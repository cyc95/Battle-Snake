...
class KILabAgentNewMinMax(BaseAgent):
    ...
    def move(self, game_info: GameInfo, turn: int, board: BoardState, you: Snake) -> MoveResult:
        ...
        clib_minmax = cdll.LoadLibrary('./agents/KILabAgentGroup8/shared_objects/test.so')
        # clib_minmax = cdll.LoadLibrary('./minmax.so')
        clib_mcts = cdll.LoadLibrary('./agents/KILabAgentGroup8/shared_objects/test.so')
