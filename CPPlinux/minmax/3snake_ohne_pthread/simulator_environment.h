...
namespace cyc{
    ...
    public:      //There are no private variables. The variables are directly used for speed
        int state[11][11]{}, you_snake_head[2]{}, opp_snake_head[4]{}, you_snake_length, opp_snake_length[2]{}, you_snake_health,
                opp_snake_health[2]{}, you_snake_direction, opp_snake_direction[2]{};
        ...
        // 2: RIGHT x+1
        // 3: DOWN y-1
        bool step(const int &you_action, const int &opp_action1, const int &opp_action2){
            if(!you_snake_health || (!*opp_snake_health && !*(opp_snake_health+1) )) return true;
            int i,j;
            bool you_get_food = false;
            bool opp_get_food[2] = {false, false};
