...
float calculate_field(std::vector<cyc::position> &you_vector, std::vector<cyc::position> &opp_vector, const int* input_state, int* state, int* control_state, const int &input_you_snake_length, const int &input_opp_snake_length, const int &input_you_snake_health,  const int &input_opp_snake_health, const int *input_you_snake_head, const int * input_opp_snake_head){
    ...
    if(input_you_snake_health <70) food_values -=3;
    if(input_you_snake_health <60) food_values -= 5;
    if(input_you_snake_health <50) food_values -= 10;
    if(input_you_snake_health <30) food_values -= 15;
    if(input_you_snake_health <15) food_values -= 20;
    if(input_you_snake_length-input_opp_snake_length <= 2 && input_you_snake_length-input_opp_snake_length >= -5) food_values = food_values + (float)input_you_snake_length * 6 - (float) input_opp_snake_length * 6;
    if(input_you_snake_length-input_opp_snake_length < -5 && input_you_snake_length-input_opp_snake_length >= -15) food_values = food_values + (float)input_you_snake_length * 2 - (float) input_opp_snake_length  * 2 - 20;
    if(input_you_snake_length-input_opp_snake_length < -15 && input_you_snake_length-input_opp_snake_length >= -25) food_values = food_values + ((float)input_you_snake_length  - (float) input_opp_snake_length)  - 35;
    if(input_you_snake_length-input_opp_snake_length < -25 ) food_values =food_values - 60;
    if(input_you_snake_length-input_opp_snake_length > 2) food_values = food_values + 15 - ((float)input_you_snake_length  - (float) input_opp_snake_length)  ;
    ...
    result = result +  food_values * (121 - std::abs(result)) / 121;
    return result;
}